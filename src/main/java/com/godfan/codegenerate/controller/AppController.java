...
import com.godfan.codegenerate.annotation.AuthCheck;
import com.godfan.codegenerate.common.BaseResponse;
import com.godfan.codegenerate.common.DeleteRequest;
import com.godfan.codegenerate.common.ResultUtils;
import com.godfan.codegenerate.constant.AppConstant;
import com.godfan.codegenerate.constant.UserConstant;
...
import com.godfan.codegenerate.model.dto.app.*;
...
public class AppController {
    ...
    /**
     * 应用聊天生成代码（流式 SSE）
     * produces = MediaType.TEXT_EVENT_STREAM_VALUE 流式声明
     * @param appId   应用 ID
     * @param message 用户消息
     * @param request 请求对象
     * @return 生成结果流
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.godfan.codegenerate.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
